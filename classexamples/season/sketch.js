...
for(var i = 0; i<snowAmount; i++){
  snowX[i] = random(0,width); //choose a number from 0 to the width - 1 or in this case 399
...
//var i gets destryoed after the loop is done, so you can use it again
...
if(snowY[x] > height){
  //snowY[x] =0;
  snowY[x] = random(0, -500); //this will make it reset to random location after hitting the bottom
